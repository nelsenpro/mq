/**
 * myqr - JavaScript Library created and developed by Nelsen Niko.
 * 
 * This library, named "myqr," is designed to provide functionalities
...
const version = "1.0.0";
console.log("Welcome to MyQR library! Version : " + version);
...
$.prototype = {
    ...
    addClass: function (className) {
        try {
            ...
            console.error("Error in addClass method:", error.message);
            // You can choose to handle the error further or throw it if needed
        }
    ...
    removeClass: function (className) {
        try {
            ...
            console.error("Error in removeClass method:", error.message);
            // You can choose to handle the error further or throw it if needed
        }
